---
name: pitch-content
description: The plan for my pitch for the presentation. The pitch itself is at [pitch.md](./pitch.md). DO NOT modify this file unless I say so. Unlike the pitch itself, this one is not what I'll say. It can be more detailed/brainstormy.
---
